		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$type = array('',"Admin","Teacher","HOD", "Lipik", "Principal");
					$qry = $conn->query("SELECT *,concat(user_name,' ',user_surname) as name FROM gpd_users order by concat(user_name,' ',user_surname) asc");
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_user" href="javascript:void(0)" data-id="<?php echo $row['user_id'] ?>">View</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item" href="./index.php?page=edit_user&id=<?php echo $row['user_id'] ?>">Edit</a>
		                      <div class="dropdown-divider"></div>
