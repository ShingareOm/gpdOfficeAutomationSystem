					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select  name="user_type_id" id="type" <?php echo (isset($user_type_id) && $user_type_id == 1) ? 'disabled' : '' ?> class="custom-select custom-select-sm" onchange="checkuser(this)">
								<option value="5" <?php echo isset($user_type_id) && $user_type_id == 5 ? 'selected' : '' ?>>Principal</option>
								<option value="4" <?php echo isset($user_type_id) && $user_type_id == 4 ? 'selected' : '' ?>>Lipik</option>
								<option value="3" <?php echo isset($user_type_id) && $user_type_id == 3 ? 'selected' : '' ?>>HOD</option>
								<option value="2" <?php echo isset($user_type_id) && $user_type_id == 2 ? 'selected' : '' ?>>Teacher</option>
						...
						?>
						<div id="hoddept" class="form-group"  <?php echo isset($user_type_id) && ($user_type_id == 2 || $user_type_id == 3) ? '' : 'hidden' ?>>
